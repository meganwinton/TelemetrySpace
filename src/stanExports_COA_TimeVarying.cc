...
#include "stanExports_COA_TimeVarying.h"

RCPP_MODULE(stan_fit4COA_TimeVarying_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_COA_TimeVarying")

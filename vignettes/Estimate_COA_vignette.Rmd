...
author: "Megan Winton"
date: "2018-06-06, updated 2025-06-04"
...
## p0    0.2817934 0.0001725392 0.02618461 0.2340307 0.2636809
## sigma 0.2847238 0.0001072995 0.01508091 0.2559770 0.2743893
##             50%       75%     97.5%    n_eff     Rhat
## p0    0.2803280 0.2985030 0.3368880 23031.21 1.000137
## sigma 0.2844869 0.2946982 0.3150428 19754.23 1.000181
```
...
## , , 1
## 
##       time           x         y    x.lower     x.upper
##  [1,]    1 -0.04525126 0.2930409 -0.1463115  0.05568694
##  [2,]    2 -0.02331320 0.3598550 -0.1441177  0.09758268
##  [3,]    3 -0.09800244 0.3846045 -0.2562022  0.05195347
##  [4,]    4 -0.12474268 0.2838824 -0.2813731  0.02360700
##  [5,]    5 -0.16819962 0.3241106 -0.3280889 -0.01894017
##  [6,]    6 -0.12551806 0.7053670 -0.4745952  0.18394287
##  [7,]    7 -0.04964369 0.3661904 -0.1678032  0.06655696
##  [8,]    8 -0.15517092 0.4038555 -0.2820209 -0.03485121
##  [9,]    9 -0.04998510 0.3349089 -0.2180100  0.11332402
## [10,]   10 -0.09944474 0.3138069 -0.2956008  0.08216338
##          y.lower   y.upper
##  [1,] 0.18723988 0.4004977
##  [2,] 0.22064130 0.5003810
##  [3,] 0.20054367 0.5694162
##  [4,] 0.11300141 0.4683321
##  [5,] 0.14745799 0.5083355
##  [6,] 0.12912751 0.8841626
##  [7,] 0.23721024 0.4963130
##  [8,] 0.26864817 0.5367750
##  [9,] 0.13165601 0.5511399
## [10,] 0.08552143 0.5677886
```
...
for (i in 1:nind){
  ...
  EN[[i]]=cbind(data.table::melt(data.table::data.table(ew[[i]])),
    data.table::melt(data.table::data.table(ns[[i]]))[,2])
...
```
## Warning in melt.data.table(data.table::data.table(ew[[i]])):
## id.vars and measure.vars are internally guessed when both are
## 'NULL'. All non-numeric/integer/logical type columns are
## considered id.vars, which in this case are columns [].
## Consider providing at least one of 'id' or 'measure' vars in
## future.
```

```
## Warning in melt.data.table(data.table::data.table(ns[[i]])):
## id.vars and measure.vars are internally guessed when both are
## 'NULL'. All non-numeric/integer/logical type columns are
## considered id.vars, which in this case are columns [].
## Consider providing at least one of 'id' or 'measure' vars in
...
# Plot in ggplot
require(hexbin) # Package required to plot uncertainty clouds around COA estimates
...
```
##          warmup  sample
## chain:1 128.741 115.091
## chain:2 126.727  95.681
## chain:3 125.629  96.234
## chain:4 128.921  94.254
```
...
```
##         warmup sample
## chain:1 83.644 77.896
## chain:2 87.361 73.577
## chain:3 90.770 74.635
## chain:4 85.124 73.420
```

...
author: "Megan Winton"
date: "2018-06-06, updated 2025-06-02"
...
## p0    0.2816098 0.0001813604 0.02616856 0.2336129 0.2636594 0.2802601
## sigma 0.2847648 0.0001125419 0.01490953 0.2557583 0.2747175 0.2847425
##             75%     97.5%    n_eff      Rhat
## p0    0.2983083 0.3370475 20819.71 0.9999236
## sigma 0.2946502 0.3144734 17550.90 0.9999243
```
...
## , , 1
## 
##       time           x         y    x.lower     x.upper   y.lower   y.upper
##  [1,]    1 -0.04562983 0.2927974 -0.1460015  0.05380061 0.1860443 0.4024706
##  [2,]    2 -0.02279693 0.3594920 -0.1451067  0.10048378 0.2192032 0.5019756
##  [3,]    3 -0.09918170 0.3838710 -0.2564443  0.05066752 0.1944144 0.5679439
##  [4,]    4 -0.12362013 0.2827371 -0.2824332  0.02496207 0.1108066 0.4705820
##  [5,]    5 -0.16982891 0.3257759 -0.3318031 -0.01874709 0.1481573 0.5117793
##  [6,]    6 -0.12782389 0.7020318 -0.4759313  0.18857239 0.1091342 0.8871488
##  [7,]    7 -0.04974917 0.3670782 -0.1653764  0.06577540 0.2345002 0.4985898
##  [8,]    8 -0.15533665 0.4043992 -0.2818052 -0.03394364 0.2680841 0.5396112
##  [9,]    9 -0.05027276 0.3346342 -0.2171070  0.11475301 0.1273728 0.5483445
## [10,]   10 -0.10047669 0.3149532 -0.2957016  0.08186775 0.0829769 0.5677180
```
...
```
## Warning in melt.data.table(data.table::data.table(ew[[i]])): id.vars and
...
## this case are columns []. Consider providing at least one of 'id' or
## 'measure' vars in future.
```

```
## Warning in melt.data.table(data.table::data.table(ns[[i]])): id.vars and
## measure.vars are internally guessed when both are 'NULL'. All
## non-numeric/integer/logical type columns are considered id.vars, which in
## this case are columns []. Consider providing at least one of 'id' or
## 'measure' vars in future.
...
```
##          warmup  sample
## chain:1 146.410 111.174
## chain:2 148.655 111.860
## chain:3 144.489 110.866
## chain:4 146.529 197.711
```
...
```
##          warmup sample
## chain:1  96.375 71.560
## chain:2 112.096 68.269
## chain:3 105.782 71.092
## chain:4  97.608 70.662
```
